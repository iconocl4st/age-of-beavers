...
public class SelectedUnits extends JPanel implements SelectionManager.SelectionListener {
    ...
    private List<EntityId> selectedUnits = Collections.emptyList();


    public SelectedUnits(ClientContext context) {
    ...
    public static SelectedUnits createSelectedUnits(final ClientContext clientContext) {
