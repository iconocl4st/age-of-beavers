...
public class UnitActions extends JPanel implements SelectionManager.SelectionListener {
    ...
    public void selectionChanged(List<EntityId> newSelectedUnits) {
        synchronized (sync) {
            ...
            for (EntityId entity : newSelectedUnits) {
                currentlySelected.add(new EntityReader(context.gameState, entity));
            }
    ...
    public static UnitActions createUnitActions(final ClientContext clientContext) {
